...
public class FileHandler {
    ...
    public byte[] parseBoardPictureByteFile(BoardPicture boardPicture) throws IOException {
    ...
    public byte[] parsePathByteFile(String imagePath) throws IOException {
        if(imagePath == null){
            return null;
        }
    ...
    public List<BoardPicture> parseFileBoardPictureInfo(
            Board board,
    ...
    public void deleteImage(String path){
        String absolutePath = System.getProperty("user.dir") + "\\";
        File deleteFolder = new File(absolutePath + path);
